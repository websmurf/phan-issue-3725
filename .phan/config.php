...
return [
    ...
    // Automatically inferred from composer.json requirement for "php" of ">=7.1.13"
    ...
    'exclude_file_regex' => '@(Test\.php$|vendor/.*/(tests|Tests)/)@',
    ...
    'autoload_internal_extension_signatures' => [
        'apcu' => '.phan/stubs/apcu.phan_php',
//        'mbstring' => '.phan/stubs/mbstring.phan_php'
    ],
